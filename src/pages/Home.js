...
const Home = () => {
    return (
        <main className="bg-gradient-to-br from-green-200 via-blue-100 to-green-200 h-screen antialiased text-center flex justify-center items-center">
            <div className="max-w-xs lg:max-w-lg md:ml-16">
                ...
                <div className="mx-5">
                    ...
                    <Link to='signup' className="text-md lg:text-2xl transform hover:scale-105 text-white font-bold block p-3 lg:p-5 m-auto rounded-full bg-green-500 hover:bg-green-400 transition-all tracking-wider uppercase " >
